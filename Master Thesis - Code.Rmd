...
```{r setup}
# Setting the directory to get data
...
## Calculating average page visits for the first 21 days
...
# Obtaining variables used for clustering
```{r}
set.seed(100)
...
# Calculating the metrics to evaluate the clustering solution
```{r}
...
# Visual representation of clusters created
```{r}
set.seed(10)
...
# Deleting Polish special characters
...
# Finding how often specific phrases occur
```{r}
...
# Checking for the values for specific percentiles
...
# The distribution after log-transformation
```{r}
...
# Create a summary with statistics for all models
...
# Adding an optimal listing for Class 2
...
# Checking how the optimal listing was estimated by the model
